...
use frame_support::{
    ...
    traits::{
        ConstU16, ConstU32, EnsureOneOf, EqualPrivilegeOnly, Everything, LockIdentifier, Nothing,
        U128CurrencyToVote,
    },
    weights::{
...
type EnsureRootOrPluralityCouncil =
    EnsureOneOf<AccountId, EnsureOneOf<EureRoot<AccountId>, PluralityCouncil>>;
